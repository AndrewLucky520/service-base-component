...
public final class MimeUtils {
    public static final String DFT_MIME = "application/octet-stream";
    ...
    public static String getMimeType(String extension) {
        ...
        String ret = extensionToMimeTypeMap.get(extension.toLowerCase());
        if (ret == null) {
            ret = DFT_MIME;
        }
        return ret;
    ...
    public static boolean isSupportImage(String extension) {
        if (StringUtils.isBlank(extension)) {
            return false;
        }
        ...
        String ret = imageTypes.get(extension.toLowerCase());
        return ret != null;
    }

    public static HashMap<String, String>  imageTypes = new HashMap<String, String>();
    static {
    	imageTypes.put("gif", "");
    	imageTypes.put("jpg", "");
    	imageTypes.put("jpeg", "");
